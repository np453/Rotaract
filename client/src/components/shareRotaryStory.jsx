...
export default class ShareRotaryStory extends Component {
    render() {
        return (
            <div>
                <div className="story_container mt-5">
                            ...
                            <div className="col-md-12">
                                <div className="row form__row">
                                    ...
                                    <div className="col-md-7">
                                        <form className="share_story_form_container">
                                            ...
                                            <div className="col-md-10 p-0 story_title_input">
                                                <input name="title" id="title" className="w-100 m-0 p-0" type="text" placeholder="story title"/>
                                            ...
                                            <div className="col-md-10 p-0 story__section">      
                                                <textarea rows="9" className="w-100 m-0 p-0" name="story" id="story" type="text" placeholder="Be clear with your words and elaborate your story "/>
                                            </div> 
                                        </form>
                                    </div>
                                </div>
